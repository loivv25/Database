...
// NHẬP VÀO YES/NO VÀ TRẢ VỀ KIỂU BOOLEAN TƯƠNG ỨNG
	public static boolean inputYesNo(String errorMessage) {
		while (true) {
			String yesNo = ScannerUtils.inputString(errorMessage);
